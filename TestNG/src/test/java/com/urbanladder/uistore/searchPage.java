...
public class searchPage {
	...
	public static By searchResult=By.xpath("//body/div[1]/div[1]/div[2]/div[1]/div[1]/h2[1]/span[1]");
	public static By storeLoaction=By.xpath("//body[1]/div[1]/div[1]/div[2]/div[2]/div[4]/div[1]/address[1]/div[3]/span[1]");
	public static By contactEmail=By.xpath("//a[contains(text(),'hello@urbanladder.com')]");
	public static By helpSearchResult=By.xpath("//span[contains(text(),\"'Payment'\")]");
